...
export const SequenceItem: React.FC<SequenceItemProps> = ({
  ...
  if (item.is_gap) {
    return (
      <div className={`aspect-square border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center bg-gray-50 relative group ${isDragging ? 'cursor-grabbing' : 'cursor-grab'}`}>
  ...
  return (
    <div className={`aspect-square border border-gray-200 rounded-lg overflow-hidden bg-gray-100 relative group ${isDragging ? 'cursor-grabbing' : 'cursor-grab'}`}>
      <img
